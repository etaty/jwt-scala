...
trait JwtCore[H, C] {
  ...
  /** Encode a JSON Web Token from its different parts. Both the header and the claim will be encoded to Base64 url-safe, then a signature will be eventually generated from it if you did pass a key and an algorithm, and finally, those three parts will be merged as a single string, using dots as separator.
    ...
    */
  def encode[T : KeyToArrayByte](header: String, claim: String, key: T, algorithm: JwtAlgorithm): String = {
  ...
  def encode(header: String, claim: String, key: PrivateKey, algorithm: JwtAsymetricAlgorithm): String = {
    val data = JwtBase64.encodeString(header) + "." + JwtBase64.encodeString(claim)
    data + "." + JwtBase64.encodeString(JwtUtils.sign(data, key, algorithm))
  }
  ...
  /** An alias to `encode` which will provide an automatically generated header and allowing you to get rid of Option
    ...
    * @param algorithm $algo
    */
  def encode[T : KeyToArrayByte](claim: String, key: T, algorithm: JwtAlgorithm): String =
  ...
  /** An alias to `encode` which will provide an automatically generated header and use the claim as a case class.
    ...
    * @param algorithm $algo
    */
  def encode[T : KeyToArrayByte](claim: JwtClaim, key: T, algorithm: JwtAlgorithm): String =
  ...
  /** An alias of `encode` if you only want to pass a string as the key, the algorithm will be deduced from the header.
    ...
    */
  def encode[T : KeyToArrayByte](header: JwtHeader, claim: JwtClaim, key: T): String = header.algorithm match {
  ...
  /** Will try to decode a JSON Web Token to raw strings using a HMAC algorithm
    ...
    */
  def decodeRawAll[T : KeyToArrayByte](token: String, key: T, algorithms: Seq[JwtHmacAlgorithm], options: JwtOptions): Try[(String, String, String)] = Try {
    val (header64, header, claim64, claim, signature) = splitToken(token)
    validate(header64, parseHeader(header), claim64, parseClaim(claim), signature, key, algorithms, options)
    (header, claim, signature)
  }

  def decodeRawAll[T : KeyToArrayByte](token: String, key: T, algorithms: Seq[JwtHmacAlgorithm]): Try[(String, String, String)] =
  ...
  /** Will try to decode a JSON Web Token to raw strings using an asymetric algorithm
    ...
    * @param algorithms $algos
    */
  def decodeRawAll[T : KeyToArrayByte](token: String, key: T, algorithms: => Seq[JwtAsymetricAlgorithm], options: JwtOptions): Try[(String, String, String)] = Try {
    val (header64, header, claim64, claim, signature) = splitToken(token)
    validate(header64, parseHeader(header), claim64, parseClaim(claim), signature, key, algorithms, options)
    (header, claim, signature)
  }

  def decodeRawAll[T : KeyToArrayByte](token: String, key: T, algorithms: => Seq[JwtAsymetricAlgorithm]): Try[(String, String, String)] =
    decodeRawAll(token, key, algorithms, JwtOptions.DEFAULT)
  ...
  /** Will try to decode a JSON Web Token to raw strings using an asymetric algorithm
    ...
    * @param algorithms $algos
    */
  def decodeRawAll(token: String, key: PublicKey, algorithms: Seq[JwtAsymetricAlgorithm], options: JwtOptions): Try[(String, String, String)] = Try {
    val (header64, header, claim64, claim, signature) = splitToken(token)
    validate(header64, parseHeader(header), claim64, parseClaim(claim), signature, key, algorithms, options)
    (header, claim, signature)
  }

  def decodeRawAll(token: String, key: PublicKey, algorithms: Seq[JwtAsymetricAlgorithm]): Try[(String, String, String)] =
    decodeRawAll(token, key, algorithms, JwtOptions.DEFAULT)

  def decodeRawAll(token: String, key: PublicKey, options: JwtOptions): Try[(String, String, String)] =
    decodeRawAll(token, key, JwtAlgorithm.allAsymetric, options)
  ...
  /** Same as `decodeRawAll` but only return the claim (you only care about the claim most of the time)
    ...
    * @param algorithms $algos
    */
  def decodeRaw[T : KeyToArrayByte](token: String, key: T, algorithms: Seq[JwtHmacAlgorithm], options: JwtOptions): Try[String] =
    decodeRawAll(token, key, algorithms, options).map(_._2)

  def decodeRaw[T : KeyToArrayByte](token: String, key: T, algorithms: Seq[JwtHmacAlgorithm]): Try[String] =
  ...
  /** Same as `decodeRawAll` but only return the claim (you only care about the claim most of the time)
    ...
    * @param algorithms $algos
    */
  def decodeRaw[T : KeyToArrayByte](token: String, key: T, algorithms: => Seq[JwtAsymetricAlgorithm], options: JwtOptions): Try[String] =
    decodeRawAll(token, key, algorithms, options).map(_._2)

  def decodeRaw[T : KeyToArrayByte](token: String, key: T, algorithms: => Seq[JwtAsymetricAlgorithm]): Try[String] =
    decodeRaw(token, key, algorithms, JwtOptions.DEFAULT)
  ...
  /** Same as `decodeRawAll` but only return the claim (you only care about the claim most of the time)
    ...
    * @param algorithms $algos
    */
  def decodeRaw(token: String, key: PublicKey, algorithms: Seq[JwtAsymetricAlgorithm], options: JwtOptions): Try[String] =
    decodeRawAll(token, key, algorithms, options).map(_._2)
  ...
  /** Same as `decodeRawAll` but only return the claim (you only care about the claim most of the time)
    ...
    * @param key $key
    */
  def decodeRaw(token: String, key: PublicKey, options: JwtOptions): Try[String] = decodeRaw(token, key, JwtAlgorithm.allAsymetric, options)
  ...
  /** Same as `decodeRawAll` but return the real header and claim types
    ...
    * @param algorithms $algos
    */
  def decodeAll[T : KeyToArrayByte](token: String, key: T, algorithms: Seq[JwtHmacAlgorithm], options: JwtOptions): Try[(H, C, String)] = Try {
    val (header64, header, claim64, claim, signature) = splitToken(token)
    val (h, c) = (parseHeader(header), parseClaim(claim))
  ...
  def decodeAll[T : KeyToArrayByte](token: String, key: T, algorithms: Seq[JwtHmacAlgorithm]): Try[(H, C, String)] =
  ...
  /** Same as `decodeRawAll` but return the real header and claim types
    ...
    * @param algorithms $algos
    */
  def decodeAll[T : KeyToArrayByte](token: String, key: T, algorithms: => Seq[JwtAsymetricAlgorithm], options: JwtOptions): Try[(H, C, String)] = Try {
    val (header64, header, claim64, claim, signature) = splitToken(token)
    val (h, c) = (parseHeader(header), parseClaim(claim))
    validate(header64, h, claim64, c, signature, key, algorithms, options)
    (h, c, signature)
  ...
  def decodeAll[T : KeyToArrayByte](token: String, key: T, algorithms: => Seq[JwtAsymetricAlgorithm]): Try[(H, C, String)] =
    decodeAll(token, key, algorithms, JwtOptions.DEFAULT)
  ...
  /** Same as `decodeRawAll` but return the real header and claim types
    ...
    * @param algorithms $algos
    */
  def decodeAll(token: String, key: PublicKey, algorithms: Seq[JwtAsymetricAlgorithm], options: JwtOptions): Try[(H, C, String)] = Try {
    val (header64, header, claim64, claim, signature) = splitToken(token)
    val (h, c) = (parseHeader(header), parseClaim(claim))
    validate(header64, h, claim64, c, signature, key, algorithms, options)
    (h, c, signature)
  ...
  def decodeAll(token: String, key: PublicKey, algorithms: Seq[JwtAsymetricAlgorithm]): Try[(H, C, String)] =
    decodeAll(token, key, algorithms, JwtOptions.DEFAULT)
  ...
  def decodeAll(token: String, key: PublicKey, options: JwtOptions): Try[(H, C, String)] =
    decodeAll(token, key, JwtAlgorithm.allAsymetric, options)
  ...
  /** Same as `decodeAll` but only return the claim
    ...
    * @param algorithms $algos
    */
  def decode[T : KeyToArrayByte](token: String, key: T, algorithms: Seq[JwtHmacAlgorithm], options: JwtOptions): Try[C] =
    decodeAll(token, key, algorithms, options).map(_._2)

  def decode[T : KeyToArrayByte](token: String, key: T, algorithms: Seq[JwtHmacAlgorithm]): Try[C] =
  ...
  /** Same as `decodeAll` but only return the claim
    ...
    * @param algorithms $algos
    */
  def decode[T : KeyToArrayByte](token: String, key: T, algorithms: => Seq[JwtAsymetricAlgorithm], options: JwtOptions): Try[C] =
    decodeAll(token, key, algorithms, options).map(_._2)

  def decode[T : KeyToArrayByte](token: String, key: T, algorithms: => Seq[JwtAsymetricAlgorithm]): Try[C] =
    decode(token, key, algorithms, JwtOptions.DEFAULT)
  ...
  /** Same as `decodeAll` but only return the claim
    ...
    * @param algorithms $algos
    */
  def decode(token: String, key: PublicKey, algorithms: Seq[JwtAsymetricAlgorithm], options: JwtOptions): Try[C] =
    decodeAll(token, key, algorithms, options).map(_._2)
  ...
  /** Same as `decodeAll` but only return the claim
    ...
    * @param key $key
    */
  def decode(token: String, key: PublicKey, options: JwtOptions): Try[C] = decode(token, key, JwtAlgorithm.allAsymetric, options)
  ...
  // Validate if an algorithm is inside the authorized range
  protected def validateAsymetricAlgorithm(algorithm: JwtAsymetricAlgorithm, algorithms: Seq[JwtAsymetricAlgorithm]): Boolean = {
    algorithms.contains(algorithm)
  }
  ...
  protected def validate[T : KeyToArrayByte](header64: String, header: H, claim64: String, claim: C, signature: String, key: T, algorithms: Seq[JwtHmacAlgorithm], options: JwtOptions): Unit = {
  ...
  // Generic validation on String Key for asymetric algorithms
  protected def validate[T : KeyToArrayByte](header64: String, header: H, claim64: String, claim: C, signature: String, key: T, algorithms: => Seq[JwtAsymetricAlgorithm], options: JwtOptions): Unit = {
    validate(header64, header, claim64, claim, signature, options, (data: Array[Byte], signature: Array[Byte], algorithm: JwtAlgorithm) => algorithm match {
      case algo: JwtAsymetricAlgorithm => validateAsymetricAlgorithm(algo, algorithms) && JwtUtils.verify(data, signature, key, algo)
      case _ => false
    })
  }
  ...
  protected def validate(header64: String, header: H, claim64: String, claim: C, signature: String, key: PublicKey, algorithms: Seq[JwtAsymetricAlgorithm], options: JwtOptions): Unit = {
    validate(header64, header, claim64, claim, signature, options, (data: Array[Byte], signature: Array[Byte], algorithm: JwtAlgorithm) => algorithm match {
      case algo: JwtAsymetricAlgorithm => validateAsymetricAlgorithm(algo, algorithms) && JwtUtils.verify(data, signature, key, algo)
      case _ => false
    })
  ...
  /** An alias of `validate` in case you want to directly pass a string key for HMAC algorithms.
    ...
    * @throws IllegalArgumentException couldn't decode the token since it's not a valid base64 string
    */
  def validate[T : KeyToArrayByte](token: String, key: T, algorithms: Seq[JwtHmacAlgorithm], options: JwtOptions): Unit = {
    val (header64, header, claim64, claim, signature) = splitToken(token)
    validate(header64, parseHeader(header), claim64, parseClaim(claim), signature, key, algorithms, options)
  }

  def validate[T : KeyToArrayByte](token: String, key: T, algorithms: Seq[JwtHmacAlgorithm]): Unit = validate(token, key, algorithms, JwtOptions.DEFAULT)
  ...
  /** An alias of `validate` in case you want to directly pass a string key for asymetric algorithms.
    ...
    * @throws IllegalArgumentException couldn't decode the token since it's not a valid base64 string
    */
  def validate[T : KeyToArrayByte](token: String, key: T, algorithms: => Seq[JwtAsymetricAlgorithm], options: JwtOptions): Unit = {
    val (header64, header, claim64, claim, signature) = splitToken(token)
    validate(header64, parseHeader(header), claim64, parseClaim(claim), signature, key, algorithms, options)
  }

  def validate[T : KeyToArrayByte](token: String, key: T, algorithms: => Seq[JwtAsymetricAlgorithm]): Unit = validate(token, key, algorithms, JwtOptions.DEFAULT)
  ...
  /** An alias of `validate` in case you want to directly pass a string key.
    ...
    * @throws IllegalArgumentException couldn't decode the token since it's not a valid base64 string
    */
  def validate(token: String, key: PublicKey, algorithms: Seq[JwtAsymetricAlgorithm], options: JwtOptions): Unit = {
    val (header64, header, claim64, claim, signature) = splitToken(token)
    validate(header64, parseHeader(header), claim64, parseClaim(claim), signature, key, algorithms, options)
  }

  def validate(token: String, key: PublicKey, algorithms: Seq[JwtAsymetricAlgorithm]): Unit = validate(token, key, algorithms, JwtOptions.DEFAULT)

  def validate(token: String, key: PublicKey, options: JwtOptions): Unit = validate(token, key, JwtAlgorithm.allAsymetric, options)
  ...
  /** An alias for `isValid` if you want to directly pass a string as the key for HMAC algorithms
    ...
    * @param algorithms $algos
    */
  def isValid[T: KeyToArrayByte](token: String, key: T, algorithms: Seq[JwtHmacAlgorithm], options: JwtOptions): Boolean =
    try {
  ...
  def isValid[T : KeyToArrayByte](token: String, key: T, algorithms: Seq[JwtHmacAlgorithm]): Boolean = isValid(token, key, algorithms, JwtOptions.DEFAULT)
  ...
  /** An alias for `isValid` if you want to directly pass a string as the key for asymetric algorithms
    ...
    * @param algorithms $algos
    */
  def isValid[T : KeyToArrayByte](token: String, key: T, algorithms: => Seq[JwtAsymetricAlgorithm], options: JwtOptions): Boolean =
    try {
      validate(token, key, algorithms, options)
      true
    } catch {
  ...
  def isValid[T : KeyToArrayByte](token: String, key: T, algorithms: => Seq[JwtAsymetricAlgorithm]): Boolean = isValid(token, key, algorithms, JwtOptions.DEFAULT)
  ...
  /** An alias for `isValid` if you want to directly pass a string as the key
    ...
    * @param algorithms $algos
    */
  def isValid(token: String, key: PublicKey, algorithms: Seq[JwtAsymetricAlgorithm], options: JwtOptions): Boolean =
    try {
      validate(token, key, algorithms, options)
      true
    } catch {
  ...
  def isValid(token: String, key: PublicKey, algorithms: Seq[JwtAsymetricAlgorithm]): Boolean = isValid(token, key, algorithms, JwtOptions.DEFAULT)

  def isValid(token: String, key: PublicKey, options: JwtOptions): Boolean = isValid(token, key, JwtAlgorithm.allAsymetric, options)
